...
template<class RadnomIter, class OutputIter>
OutputIter
unchecked_move_cat(RadnomIter first, RadnomIter last, OutputIter result, mystl::random_access_iterator_tag)
{
	for (auto n = last - first; n > 0; --n, ++first, ++result)
	{
		*result = mystl::move(*first);
...
/*****************************************************************************************/
template <class BidireactionalIter1, class BidireactionalIter2>
BidireactionalIter2
unchecked_move_backward_cat(BidireactionalIter1 first, BidireactionalIter1 last, BidireactionalIter2 result, mystl::bidirectional_iterator_tag)
{
	while (first != last)
...
RandomIter2
unchecked_move_backward_cat(RandomIter1 first, RandomIter1 last, RandomIter2 result, mystl::random_access_iterator_tag)
{
	for (auto n = last - first; n > 0; --n)
		*--result = mystl::move(*--last);
